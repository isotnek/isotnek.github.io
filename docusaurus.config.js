...
//const GitHubIcon = require('./static/img/icons/github.svg');
//const LinkedInIcon = require('./static/img/icons/linkedin.svg');
//const EnvelopeIcon = require('./static/img/icons/envelope-solid.svg');
    ...
    navbar: {
      ...
      */
      items: [
        ...
        */
        ...
        /*
        {
          ...
          position: 'right',
          html: `
              <a href="/contactMe" class="custom-icon email-icon">
        ...
        },        
        {
          ...
          position: 'right',
          html: `
              <a href="https://github.com/yourusername" class="custom-icon github-icon">
      ...
      },
      {
          ...
          position: 'right',
          html: `
              <a href="https://www.linkedin.com/in/yourprofile/" class="custom-icon linkedin-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="custom-icon">
                      <!-- Your Linkedin SVG path here -->
      ...
      */
      {to: '/contactMe', label: 'Contact', position: 'right'},
      {href: 'https://www.linkedin.com/in/ian-sotnek/', label: 'LinkedIn', position: 'right'},
      {href: 'https://github.com/isotnek', label: 'Github', position: 'right'}
      ],
    },
